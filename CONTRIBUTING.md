# Contributing to qim-streaming-server
...
1. [Fork](https://github.com/qualcomm/qim-streaming-server/fork) and clone the repository.

    ```bash
    git clone https://github.com/<username>/qim-streaming-server.git
    ```
...
1. Create an upstream `remote` to make it easier to keep your branches up-to-date:
    ...
    ```bash
    git remote add upstream https://github.com/qualcomm/qim-streaming-server.git
    ```
...
1. [Submit a pull request](https://github.com/qualcomm/qim-streaming-server/pulls) from your branch to `main`.
